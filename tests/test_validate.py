...
def test_local_name_slash_uri():
    ...
    assert _local_name("http://romanrepublic.ac.uk/rdf/entity/vocab/Person") == "Person"
    assert _local_name("http://romanrepublic.ac.uk/rdf/entity/vocab/hasOffice") == "hasOffice"
