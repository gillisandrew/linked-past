"""Download CRRO RDF, convert to Turtle via rapper, generate VoID, and push to OCI registry."""
...
ARTIFACT_REF = "ghcr.io/gillisandrew/linked-past/datasets/crro"
...
def main(version="latest"):
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        void = generate_void(
            ...
            source_uri="https://numismatics.org/crro",
            citation="ANS, CRRO. Based on Crawford (1974) Roman Republican Coinage",
